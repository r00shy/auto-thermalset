if [ "$1" = "-rebooted" ]; then
  {
    ...
    curl -o /etc/init/fanctrl-custom.conf "https://raw.githubusercontent.com/r00shy/auto-thermalset/main/customFanTemps.config?token=GHSAT0AAAAAABWBC7VFDXQFY2SNGLZ6JNJYYXD4CCQ"
