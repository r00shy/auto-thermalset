if [ "$1" = "-rebooted" ]; then
  {
    ...
    curl -H 'Authorization: token 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' -H 'Accept: application/vnd.github.v3.raw' -o /etc/init/customFanTemps.config "https://raw.githubusercontent.com/r00shy/auto-thermalset/main/customFanTemps.config"
